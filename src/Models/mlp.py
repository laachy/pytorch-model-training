...
class MLP(nn.Module):
    def __init__(self, output_size, width=512, depth=3, funnel_factor=1, dropout=0.3, lr=4e-4, weight_decay=3e-2, activation_fn=nn.ReLU, optimiser=torch.optim.AdamW, min_width=64):
        super().__init__()
    ...
    def build_for_experiment(cls, output_size, trial=None):
        ...
        return cls(output_size, width, depth, funnel_factor, dropout, lr, weight_decay, activation_fn, optimiser), batch_size